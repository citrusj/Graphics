...
#define TREE_TOP 0
#define TREE_MIDDLE 1
#define TREE_BOTTOM 2
#define TREE_STUMP 3
#define TREE_APPLE1 4
#define TREE_APPLE2 5
#define TREE_APPLE3 6
#define TREE_APPLE4 7

GLfloat tree_top[3][2] = { {-10.0, 26.0},{10.0, 26.0},{0.0, 36.0} };
GLfloat tree_mid[4][2] = { {-12.0, 14.0},{12.0, 14.0},{6.0,26.0},{-6.0, 26.0} };
GLfloat tree_bot[4][2] = { {-14.0, 0.0},{14.0, 0.0},{8.0,14.0},{-8.0, 14.0} };
GLfloat tree_stmp[4][2] = { {-5.0, 0.0},{-5.0, -14.0},{5.0,-14.0},{5.0, 0.0} };
GLfloat tree_app1[4][2] = { {7.0, 25.0},{11.0, 25.0},{10.0,27.0},{8.0, 27.0} };
GLfloat tree_app2[4][2] = { {7.0, 25.0},{11.0, 25.0},{10.0,23.0},{8.0, 23.0} };
GLfloat tree_app3[4][2] = { {-13.0, 14.0},{-9.0, 14.0},{-10.0,16.0},{-12.0, 16.0} };
GLfloat tree_app4[4][2] = { {-13.0, 14.0},{-9.0, 14.0},{-10.0,12.0},{-12.0, 12.0} };

GLfloat tree_color[8][3] = {
	{0 / 255.0f, 102 / 255.0f, 0 / 255.0f},
	{0 / 255.0f, 153 / 255.0f, 0 / 255.0f},
	{0 / 255.0f, 102 / 255.0f, 0 / 255.0f},
	{40 / 255.0f, 29 / 255.0f, 19 / 255.0f},
	{255 / 255.0f, 0 / 255.0f, 0 / 255.0f},
	{255 / 255.0f, 0 / 255.0f, 0 / 255.0f},
	{255 / 255.0f, 0 / 255.0f, 0 / 255.0f},
	{255 / 255.0f, 0 / 255.0f, 0 / 255.0f}
...
void prepare_tree() {
	GLsizeiptr buffer_size = sizeof(tree_top) + sizeof(tree_mid) + sizeof(tree_bot) + sizeof(tree_stmp) + sizeof(tree_app1) +
		sizeof(tree_app2) + sizeof(tree_app3) + sizeof(tree_app4);
	...
	glBufferSubData(GL_ARRAY_BUFFER, 0, sizeof(tree_top), tree_top);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(tree_top), sizeof(tree_mid), tree_mid);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(tree_top) + sizeof(tree_mid), sizeof(tree_bot), tree_bot);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(tree_top) + sizeof(tree_mid) + sizeof(tree_bot), sizeof(tree_stmp), tree_stmp);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(tree_top) + sizeof(tree_mid) + sizeof(tree_bot) + sizeof(tree_stmp), sizeof(tree_app1), tree_app1);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(tree_top) + sizeof(tree_mid) + sizeof(tree_bot) + sizeof(tree_stmp) + sizeof(tree_app1), sizeof(tree_app2), tree_app2);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(tree_top) + sizeof(tree_mid) + sizeof(tree_bot) + sizeof(tree_stmp) + sizeof(tree_app1) + sizeof(tree_app2), sizeof(tree_app3), tree_app3);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(tree_top) + sizeof(tree_mid) + sizeof(tree_bot) + sizeof(tree_stmp) + sizeof(tree_app1) + sizeof(tree_app2) + sizeof(tree_app3), sizeof(tree_app4), tree_app4);
	// Initialize vertex array object.
...
void draw_tree() {
	...
	glUniform3fv(loc_primitive_color, 1, tree_color[TREE_TOP]);
	glDrawArrays(GL_TRIANGLE_FAN, 0, 3);

	glUniform3fv(loc_primitive_color, 1, tree_color[TREE_MIDDLE]);
	glDrawArrays(GL_TRIANGLE_FAN, 3, 4);

	glUniform3fv(loc_primitive_color, 1, tree_color[TREE_BOTTOM]);
	glDrawArrays(GL_TRIANGLE_FAN, 7, 4);

	glUniform3fv(loc_primitive_color, 1, tree_color[TREE_STUMP]);
	glDrawArrays(GL_TRIANGLE_FAN, 11, 4);

	glUniform3fv(loc_primitive_color, 1, tree_color[TREE_APPLE1]);
	glDrawArrays(GL_TRIANGLE_FAN, 15, 4);

	glUniform3fv(loc_primitive_color, 1, tree_color[TREE_APPLE2]);
	glDrawArrays(GL_TRIANGLE_FAN, 19, 4);

	glUniform3fv(loc_primitive_color, 1, tree_color[TREE_APPLE3]);
	glDrawArrays(GL_TRIANGLE_FAN, 23, 4);

	glUniform3fv(loc_primitive_color, 1, tree_color[TREE_APPLE4]);
...
GLfloat road[4][2] = { {-25.0, 0.0 },{25.0, 0.0 },{ 2.5, 30.0},{-2.5, 30.0} };
